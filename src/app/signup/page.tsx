    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-brand-50 to-white px-4 py-10">
      <div className="w-full max-w-sm">
        <div className="mb-6 flex flex-col items-center text-center">
          ...
          <p className="text-sm text-gray-500">Start managing your properties with RentHive.</p>
        </div>
        ...
        <div className="card p-6">
          <form action={formAction} className="space-y-4">
            ...
            <div>
              <label className="label" htmlFor="company">Company <span className="font-normal text-gray-400">(optional)</span></label>
              <input id="company" name="company" className="input" placeholder="Doe Properties" />
            </div>
            <div>
            ...
            <div>
              ...
              <input id="password" name="password" type="password" className="input" placeholder="At least 8 characters" required minLength={8} />
            </div>
            {state?.error && (
